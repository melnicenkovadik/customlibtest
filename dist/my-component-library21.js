...
const r = e(
  "flex flex-row items-center justify-center gap-2 rounded-md text-sm font-medium disabled:pointer-events-none disabled:opacity-[0.37]",
  {
    variants: {
      variant: {
        primary: "bg-ui-accent-500 text-neutral-1000 hover:bg-ui-accent-400 active:bg-ui-accent-600",
        secondary: "bg-primary text-primary-text hover:bg-primary-hover active:bg-primary-active",
        tertiary: "bg-secondary hover:bg-secondary-hover active:bg-secondary-focus",
        outline: "border border-border bg-background hover:bg-ghost active:bg-secondary",
        ...
        destructive: "bg-destructive text-destructive-text hover:bg-destructive-hover active:bg-destructive-active",
        "outline-primary": "border border-ui-accent-500 bg-background hover:bg-gd-dark-xs hover:text-foreground active:bg-ui-accent-500"
      },
      size: {
