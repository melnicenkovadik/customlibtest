import{j as a}from"./jsx-runtime-DR9Q75dM.js";import{C as g}from"./index-D0XuIrdb.js";import{T}from"./index-DzN5Xk-Y.js";import{T as h}from"./index-Cv3TqRal.js";import{c as o}from"./index-BxTXOyjN.js";import{A as v}from"./authors-Bh-Wpt1v.js";import{B as b}from"./constants-BP086JmV.js";import"./index-DRjF_FHU.js";import"./index-Ds8zFNib.js";import"./index-Bb4qSo10.js";import"./index-DlETWc0l.js";import"./createLucideIcon-UCnLdqZo.js";const c=({className:m="gap-[9px]",textClasses:d,text:t,title:r,actions:s,startTruncate:p=4,variant:u="body1",isTruncate:x,...f})=>{if(!r&&!t)throw new Error("title and text props can not be empty at the same time");return a.jsxs("div",{className:o("flex items-center",m),children:[r&&a.jsx(h,{size:u,children:r}),t&&a.jsx(T,{text:t,...f,className:o(d,"gap-1"),isTruncate:x,start:p}),s.length>0&&s.map(y=>y)]})};c.__docgenInfo={description:"",methods:[],displayName:"TextWithActions",props:{text:{required:!1,tsType:{name:"string"},description:""},textClasses:{required:!1,tsType:{name:"string"},description:""},title:{required:!1,tsType:{name:"string"},description:""},variant:{required:!1,tsType:{name:"union",raw:`| 'heading1'
| 'heading2'
| 'heading3'
| 'heading4'
| 'heading5'
